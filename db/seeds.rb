...
User.create(name: "ian", password: "test", location: "San Francisco", goal: "Muscle gain", weight: "160", height: "67", bfp: "12", bmi: "25", username: "icivgin", email: "ian@test.com", avatar: "http://cdn3.rd.io/user/no-user-image-square.jpg")
User.create(name: "monika", password: "test", location: "San Francisco", goal: "Fat loss", weight: "135", height: "66", bfp: "17.5", bmi: "25", username: "xmonmon",  email: "monika@test.com", avatar: "http://cdn3.rd.io/user/no-user-image-square.jpg")
User.create(name: "sean", password: 'test', location: "San Francisco", goal: "Muscle gain", weight: "160", height: "67", bfp: "14", bmi: "25", username: "ckeeyz09", email: "sean@test.com", avatar: "http://cdn3.rd.io/user/no-user-image-square.jpg")
User.create(name: "rakesh", password: "test", location: "San Francisco", goal: "Muscle gain", weight: "160", height: "67", bfp: "13", bmi: "25", username: "rakesh87", email: "rakesh@test.com", avatar: "http://cdn3.rd.io/user/no-user-image-square.jpg")
...
Appointment.create(workouts_id: "Russian Twists", users_id: "1")
Appointment.create(workouts_id: "Hanging Leg Raises", users_id: "2")
Appointment.create(workouts_id: "Squats", users_id: "3")
Appointment.create(workouts_id: "Tricep Dip", users_id: "4")
Appointment.create(workouts_id: "Bicep Curl", users_id: "1")
Appointment.create(workouts_id: "Chest Flies", users_id: "2")
Appointment.create(workouts_id: "Dumbbell Press", users_id: "3")
Appointment.create(workouts_id: "Seated Dumbbell Wrist Curl", users_id: "4")
