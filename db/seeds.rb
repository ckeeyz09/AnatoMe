...
Appointment.create(workouts_id: "1", users_id: "1")
Appointment.create(workouts_id: "2", users_id: "2")
Appointment.create(workouts_id: "3", users_id: "3")
Appointment.create(workouts_id: "4", users_id: "4")
Appointment.create(workouts_id: "5", users_id: "1")
Appointment.create(workouts_id: "6", users_id: "2")
Appointment.create(workouts_id: "7", users_id: "3")
Appointment.create(workouts_id: "8", users_id: "4")
